     ...
     )
{
	...
	__m128i eight[8],tweaks[8],xx[3],z_s[8][3],mes[4],tweaks_sin[8];
	...
	/* Start of encrypt_block. To endsfsdfsdfc: Tag with tweak nonce. This will be a slow f*cker. */
	...
	for(i=0;i<(numblocks_mes-sin*4);i+=4)
	{
